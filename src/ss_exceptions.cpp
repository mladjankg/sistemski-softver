...
AssemblingException::AssemblingException(std::string line, int lineNumber) {
...
AssemblingException::AssemblingException(std::string msg, std::string line, int lineNumber) {
    this->message = "\nERROR: " + msg + " at line:\n";
